...
public class TwoDimArrayPractice extends JFrame {
	...
	/**
	 * Prints array to the console Each row is on a separate line. Each row begins
	 * with the row number and then a tab character. Elements are separated by a
	 * space. The instance variable named intArray is the integer array to be
	 * printed.
	 */
